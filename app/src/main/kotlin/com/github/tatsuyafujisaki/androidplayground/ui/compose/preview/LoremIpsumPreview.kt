...
@Preview(showBackground = true)
@Composable
private fun LoremIpsum8Preview(
    @PreviewParameter(LoremIpsum8::class) text: String,
) {
    Text(text = text)
}
...
@Preview(showBackground = true)
@Composable
private fun LoremIpsum18Preview(
    @PreviewParameter(LoremIpsum18::class) text: String,
) {
    Text(text = text)
}
