...
```shell
~/Library/Android/sdk/emulator/emulator -avd <emulator> -dns-server 1.1.1.1,8.8.8.8

# You don't have to specify an emulator if you have only one emulator.
~/Library/Android/sdk/emulator/emulator -avd $(~/Library/Android/sdk/emulator/emulator -list-avds) -dns-server 1.1.1.1,8.8.8.8
```
