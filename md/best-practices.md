...
### Personal best practices for Hilt
...
1. If you want to inject an interface, you have a class that implements the interface, and you can
   instantiate the class without any additional code, use @Binds.
...
## Use A rather than B for simplicity (except for Jetpack Compose)
 ...
 A                                        | B                                                           | Note                           
------------------------------------------|-------------------------------------------------------------|--------------------------------
 `Activity.resources`<br>`View.resources` | `Activity.context.resources`<br>`View.context.resources`    
 `Activity.getString(...)`                | `Activity.resources.getString(...)`                         
